...
public class FollowerConstants {
    ...
    public static String leftRearMotorName = "LBLE";
    public static String rightFrontMotorName = "RFBE";
    public static String rightRearMotorName = "RBRE";
    ...
    public static double mass = 9.97;
