...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.00197456;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.0015745366874616964;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        strafeEncoderPose = new Pose(-7.5, -0.1, Math.toRadians(90));

        hardwareMap = map;

        // TODO: replace these with your encoder ports
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "LBLE"));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "RBRE"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "RFBE"));
